  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/60 p-4 backdrop-blur-sm">
      <dialog
        ...
        className="w-full max-w-md overflow-hidden rounded-2xl border bg-card shadow-[0_28px_90px_rgb(0_0_0/35%)]"
      >
        ...
        <div className="p-5 sm:p-6">
          <div className="rounded-xl border bg-muted/45 p-4">
            <p className="flex items-center gap-2 text-sm font-semibold">
              ...
              Your input stayed with the local tool
            </p>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              This operation ran in this browser tab. No account or output gate
              was used. Formal runtime egress certification is still pending.
            </p>
          </div>
          ...
          <div className="mt-5">
            ...
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              These tools are open source and free to use. If this saved you
              time, you can optionally support testing and maintenance.
            </p>
          </div>
          <div className="mt-4 grid gap-2 sm:grid-cols-2">
            <Button
              render={
                <a
                  href="/support"
                  aria-label="Support the open-source project"
                />
              }
              className="h-11"
            >
