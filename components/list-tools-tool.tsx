...
export function ListToolsTool() {
  ...
  return (
    <div id="tool" tabIndex={-1} className="w-full focus:outline-none">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground sm:text-base">
            De-duplicate by key column, merge subscriber databases, split large
            recipient lists, compare segments, and clean PII records. Runs 100%
        ...
        {!tableA && (
          <div
            ...
            onDrop={(e) => {
              e.preventDefault();
              e.stopPropagation();
              if (e.dataTransfer.files) void handleFileA(e.dataTransfer.files);
            }}
          ...
          >
            ...
            <p className="mt-1.5 max-w-md text-xs text-muted-foreground sm:text-sm">
              Handles standard RFC 4180 CSVs, Excel UTF-8 BOM, multiline fields,
              commas in quotes, and European semicolon files.
            </p>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div>
                      ...
                      <select
                        id={dedupColSelectId}
                        value={dedupColIdx}
                        onChange={(e) => setDedupColIdx(Number(e.target.value))}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between rounded-lg border border-border bg-muted/30 p-3">
                        <div>
                          ...
                          <span className="ml-2 text-xs text-muted-foreground">
                            ({tableB.rows.length} rows, {tableB.headers.length}{' '}
                            cols)
                          </span>
                        </div>
                        <Button
                      ...
                      <div className="flex flex-wrap gap-4">
                        <label className="flex items-center gap-2 text-xs text-foreground cursor-pointer">
                          ...
                          />
                          <span>
                            Union Columns (include all columns from both lists)
                          </span>
                        </label>
                        <label className="flex items-center gap-2 text-xs text-foreground cursor-pointer">
                          <input
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-4">
                    ...
                    <label className="flex items-center gap-2 text-xs text-foreground cursor-pointer">
                      ...
                      />
                      <span>
                        Split by Column Value (e.g. by Country, Plan, or Status)
                      </span>
                    </label>
                  </div>
                  ...
                  {splitType === 'rows' ? (
                    <div className="max-w-xs space-y-1.5">
                      ...
                      <input
                        ...
                        value={splitRowCount}
                        onChange={(e) =>
                          setSplitRowCount(Math.max(1, Number(e.target.value)))
                        }
                        className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground"
                      />
                      {splitByCountResult && (
                        <p className="text-xs text-muted-foreground">
                          Will produce {splitByCountResult.chunks.length} parts.
                        </p>
                      )}
                    </div>
                  ) : (
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleDownloadTable(
                                  ...
                                  'List Group Split',
                                  [
                                    { label: 'Group', value: group.groupValue },
                                    {
                                      label: 'Rows',
                      ...
                      {compareResult && (
                        <>
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            ...
                            >
                              <div className="text-xs">Only in {filenameA}</div>
                              <div className="text-lg font-bold">
                            ...
                            >
                              <div className="text-xs">Only in {filenameB}</div>
                              <div className="text-lg font-bold">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    {tableA.headers.map((header, colIdx) => {
                      const activeRule =
                        normRules.find((r) => r.columnIndex === colIdx)?.rule ??
                        'none';
                      return (
                        <div
                          key={colIdx}
                ...
                <div className="overflow-x-auto rounded-lg border border-border">
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-border">
                      {currentOutputTable.rows.slice(0, 10).map((row, rIdx) => (
