...
export const PAGE_DEPTH_PDF: Readonly<Record<string, ToolPageDepth>> = {
  ...
  */
  ...
  '/pdf/drawing-register': {
    ...
    description:
      'Extract drawing numbers, titles, revisions, dates, and authors from architectural drawing set title blocks into CSV spreadsheets, in your browser tab.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'This tool is engineered for native vector PDFs generated by BIM and CAD software. Vector PDFs embed true text objects with searchable character strings and coordinate positions, so the characters are read exactly rather than guessed at the way OCR does with a scan. Which of those strings is the drawing number, the revision or the date is still decided by where they sit in the title block, and title blocks differ between practices — so check the register against a sheet or two before trusting it.',
    ...
    faqs: [
      {
        ...
        answer:
          'Any software that exports a standard vector PDF with a text layer is compatible. That covers the common BIM, CAD, civil and architectural packages; what matters is the text layer, not the package.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. Clicking Export Register CSV produces a comma-separated values (.csv) file containing Sheet Number, Drawing Number, Sheet Title, Revision, Date, and Author columns that opens in any spreadsheet application or construction document platform.',
      },
      {
