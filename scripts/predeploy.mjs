 ...
 * allows about 1,000 a day. A full re-warm costs 122 (61 opted-in pages, two
 ...
 * checks the per-deploy cost (122 < 900) and cannot see the deploy count, so it
...
const FULL_REWARM = 122; // 61 opted-in pages x 2 keys. docs/CACHE_BUDGET.md
