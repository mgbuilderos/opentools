 ...
 * requests it, so a quiet day spends a fraction of this. 176 opted-in pages x 2
 * keys, as of 2026-09-21. KEEP IN SYNC with `lib/seo/cache-budget.test.ts` --
