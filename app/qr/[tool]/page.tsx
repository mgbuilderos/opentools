...
/*
  ...
  Every tool under /qr used to answer on a single workbench URL behind a
  ...
  at `/qr/<id>`, each with its own title, description and canonical
...
export default async function Page(props: {
  ...
  return (
    <>
      <ToolJsonLd route={`/qr/${tool}`} meta={await generateMetadata(props)} />
      {rendered}
    </>
  );
}
