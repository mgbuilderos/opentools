...
/*
  The localised editions of `/pdf/to-word`, one static page per locale.

  ONE FILE, NOT ONE PER LANGUAGE. `generateStaticParams` returns the eight
  locale codes, so this single route file produces `/es/pdf/to-word`,
  `/ja/pdf/to-word` and the other six, each prerendered with its own title,
  ...
  segment beats a dynamic one in the router, so the English `/pdf/to-word` is
