...
/*
  ...
  Every tool under /creator used to answer on a single workbench URL behind a
  ...
  at `/creator/<id>`, each with its own title, description and canonical
...
const OPERATIONS = [
  ...new Map(
    [CREATOR_OPERATIONS].flat().map((operation) => [operation.id, operation]),
  ).values(),
];
