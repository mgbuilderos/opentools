...
/*
  ...
  Every tool under /text used to answer on a single workbench URL behind a
  ...
  at `/text/<id>`, each with its own title, description and canonical
...
const OPERATIONS = [
  ...new Map(
    [TEXT_OPERATIONS, WRITING_OPERATIONS]
      .flat()
