...
export const metadata = {
  title: 'SQL Schema Visualizer | OpenTools',
  description: 'Instant local ERD diagram generation',
};

export default function SqlVisualizerPage() {
  return (
    <AppShell currentToolId="sql-visualizer">
      <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center p-4">
        ...
        <p className="mt-4 max-w-lg text-center text-muted-foreground">
          We are building a client-side parser so you can paste SQL tables and
          instantly get a beautiful ERD diagram locally.
        </p>
