...
export const metadata = {
  title: 'On-Device OCR | OpenTools',
  description: 'Extract text from images locally',
};

export default function OCRPage() {
  return (
    <AppShell currentToolId="image-ocr">
      <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center p-4">
        ...
        <p className="mt-4 max-w-lg text-center text-muted-foreground">
          We are building a Tesseract.js integration so you can instantly
          extract text from images without sending them to a third-party API.
        </p>
